...
REPO_PREFIX="http://somehost.com/svn/repos/tags/"
...
mvn -e org.ggear.maven.plugin.resolver:org.ggear.maven.plugin.resolver.plugin:deploy \
	...
	-Dmaven.resolver.repositoryUrl="http://somehost.com:8081/nexus/content/repositories/thirdparty" 
